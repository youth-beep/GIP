import {
  ArrowRight, Clock, MapPin, Users, Star, Waves,
  Dumbbell, Trophy, ChefHat,
  Sparkles, Compass, Hammer, Zap, CalendarDays, DollarSign,
  Utensils, Music, Flag,
} from 'lucide-react';
...
function LITHero() {
  return (
    <section className="relative overflow-hidden min-h-[85vh] flex items-center px-4 py-12 sm:px-8 sm:py-16 lg:px-12 lg:py-28">
      <img
        src="/LIT.jpg"
        alt="Gan Izzy Leaders-in-Training"
      ...
      <div className="absolute bottom-10 right-6 text-3xl sm:text-4xl select-none pointer-events-none opacity-50 sm:bottom-16 sm:right-16 animate-float" aria-hidden="true">🗺️</div>
      ...
      <div className="relative w-full max-w-5xl mx-auto text-center animate-fade-in-up">
        ...
        <h1 className="font-headline text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white mb-5 sm:mb-7 leading-[0.95] tracking-tight">
          Gan Izzy
          <br />
          <span className="text-primary drop-shadow-lg">LITs</span>
        </h1>
        ...
        <p className="font-body text-base sm:text-lg lg:text-xl text-white/85 mb-10 sm:mb-12 max-w-2xl mx-auto leading-relaxed px-2">
          Leaders-in-Training — the bridge between camper and counselor. An elite program for young leaders combining real responsibility, premium experiences, and personal growth.
        </p>
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap sm:justify-center gap-2 sm:gap-3 max-w-sm mx-auto sm:max-w-none">
          ...
          <div className="flex items-center gap-2 bg-white/15 backdrop-blur-sm px-3 py-2.5 sm:px-4 sm:py-2.5 rounded-full shadow-sm ring-1 ring-white/25 border border-white/20 min-h-[44px]">
            <Compass size={15} className="text-white flex-shrink-0" />
            <span className="font-body font-bold text-xs sm:text-sm text-white leading-tight">Premium Off-Site Trips</span>
          </div>
          <div className="flex items-center gap-2 bg-white/15 backdrop-blur-sm px-3 py-2.5 sm:px-4 sm:py-2.5 rounded-full shadow-sm ring-1 ring-white/25 border border-white/20 min-h-[44px]">
...
function LITFastFacts() {
  const facts = [
    {
      icon: Users,
      label: 'Ages',
      value: '12–13 Years Old',
    ...
    },
    {
      icon: Compass,
      label: 'Location',
      value: 'Ventnor Campus & Premium Off-Site',
...
const highlights = [
  { icon: Compass,      label: 'Premium Teen Excursions',          color: 'text-secondary-green',   bg: 'bg-secondary-green/10',  iconBg: 'bg-secondary-green/20',  ring: 'ring-secondary-green/20' },
  { icon: Dumbbell,     label: 'Advanced Athletics',               color: 'text-secondary-blue',    bg: 'bg-secondary-blue/10',   iconBg: 'bg-secondary-blue/20',   ring: 'ring-secondary-blue/20' },
  { icon: Sparkles,     label: 'Specialized Leadership Electives', color: 'text-secondary-pink',    bg: 'bg-secondary-pink/10',   iconBg: 'bg-secondary-pink/20',   ring: 'ring-secondary-pink/20' },
  { icon: Hammer,       label: 'Professional Woodworking',         color: 'text-secondary-yellow',  bg: 'bg-secondary-yellow/10', iconBg: 'bg-secondary-yellow/20', ring: 'ring-secondary-yellow/20' },
  { icon: ChefHat,      label: 'Culinary Arts & Picnic Canteen',   color: 'text-secondary-green',   bg: 'bg-secondary-green/10',  iconBg: 'bg-secondary-green/20',  ring: 'ring-secondary-green/20' },
  { icon: Waves,        label: 'Deep-End Swimming',                color: 'text-secondary-blue',    bg: 'bg-secondary-blue/10',   iconBg: 'bg-secondary-blue/20',   ring: 'ring-secondary-blue/20' },
  { icon: Zap,          label: 'Counselor Mentorship Experience',  color: 'text-secondary-yellow',  bg: 'bg-secondary-yellow/10', iconBg: 'bg-secondary-yellow/20', ring: 'ring-secondary-yellow/20' },
  { icon: Trophy,       label: 'Leadership & Personal Growth',     color: 'text-primary',           bg: 'bg-primary/10',          iconBg: 'bg-primary/15',          ring: 'ring-primary/20' },
];
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="font-body text-base sm:text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            An elite program where rising leaders grow their confidence, skills, and character through real responsibility and unforgettable experiences.
          </p>
        </div>
...
const schedule = [
  { time: '9:30 AM',  activity: 'Spirit Rally',                           icon: Zap },
  { time: '10:00 AM', activity: 'Swimming & Splash Zone',                 icon: Waves },
  { time: '11:30 AM', activity: 'Advanced Athletics & Team Building',     icon: Trophy },
  { time: '12:30 PM', activity: 'Lunch & Picnic Canteen',                 icon: Utensils },
  { time: '1:30 PM',  activity: 'Skydiver Hunt',                           icon: Sparkles },
  { time: '2:00 PM',  activity: 'Magic Show',                             icon: Star },
  { time: '3:00 PM',  activity: 'Shabbat Party',                          icon: Music },
    ...
    >
      ...
      <div className="relative max-w-2xl mx-auto">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="font-body text-base sm:text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Every hour is designed to inspire, challenge, and develop the next generation of camp leaders.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl ring-1 ring-gray-100 shadow-xl overflow-hidden">
          <div className="px-5 py-4 sm:px-8 sm:py-5 flex items-center gap-3" style={{ backgroundColor: COLOR }}>
            ...
            <p className="font-headline text-lg sm:text-xl font-bold leading-tight text-white">
              LITs <span className="font-normal opacity-75 text-base">— Ages 12–13</span>
            </p>
          </div>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-primary rounded-3xl px-8 py-10 sm:px-12 sm:py-12 shadow-xl shadow-primary/20 text-center">
          ...
          <div className="relative">
            ...
            <p className="font-body text-white/75 text-base sm:text-lg max-w-md mx-auto leading-relaxed mb-8">
              View our full summer schedule, session dates, and tuition options for Gan Izzy LITs.
            </p>
            <a
              href="/dates-rates"
              onClick={(e) => { e.preventDefault(); navigate('/dates-rates'); }}
