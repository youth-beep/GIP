...
const dayOptions: DayOption[] = [
  {
    ...
    badge: 'Best Value',
    fullDay: [
      { label: 'Standard', price: '$1,100', hours: '9:00 AM – 3:00 PM' },
      { label: 'Before Care', price: '$1,290', hours: '7:30 AM – 3:00 PM' },
      { label: 'After Care', price: '$1,290', hours: '9:00 AM – 4:30 PM' },
      { label: 'Before & After Care', price: '$1,390', hours: '7:30 AM – 4:30 PM' },
      { label: 'Extended After Care', price: '$1,390', hours: '9:00 AM – 5:30 PM' },
      { label: 'Full Care', price: '$1,460', hours: '7:30 AM – 5:30 PM' },
    ],
    halfDay: [
      { label: 'Standard', price: '$805', hours: '9:00 AM – 12:00 PM' },
  ...
  },
  {
    ...
    fullDay: [
      { label: 'Standard', price: '$880', hours: '9:00 AM – 3:00 PM' },
      { label: 'Before Care', price: '$990', hours: '7:30 AM – 3:00 PM' },
      { label: 'After Care', price: '$990', hours: '9:00 AM – 4:30 PM' },
      { label: 'Before & After Care', price: '$1,045', hours: '7:30 AM – 4:30 PM' },
      { label: 'Extended After Care', price: '$1,045', hours: '9:00 AM – 5:30 PM' },
      { label: 'Full Care', price: '$1,100', hours: '7:30 AM – 5:30 PM' },
    ],
    halfDay: [
      { label: 'Standard', price: '$600', hours: '9:00 AM – 12:00 PM' },
  ...
  },
  {
    ...
    fullDay: [
      { label: 'Standard', price: '$750', hours: '9:00 AM – 3:00 PM' },
      { label: 'Before Care', price: '$830', hours: '7:30 AM – 3:00 PM' },
      { label: 'After Care', price: '$830', hours: '9:00 AM – 4:30 PM' },
      { label: 'Before & After Care', price: '$875', hours: '7:30 AM – 4:30 PM' },
      { label: 'Extended After Care', price: '$875', hours: '9:00 AM – 5:30 PM' },
      { label: 'Full Care', price: '$900', hours: '7:30 AM – 5:30 PM' },
    ],
    halfDay: [
      { label: 'Standard', price: '$525', hours: '9:00 AM – 12:00 PM' },
