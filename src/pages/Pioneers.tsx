    ...
    <section className="relative overflow-hidden min-h-[85vh] flex items-center px-4 py-12 sm:px-8 sm:py-16 lg:px-12 lg:py-28">
      ...
      <div className="relative w-full max-w-5xl mx-auto text-center animate-fade-in-up">
        ...
        <h1 className="font-headline text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white mb-5 sm:mb-7 leading-[0.95] tracking-tight">
          Gan Izzy
          <br />
          <span className="text-primary drop-shadow-lg">Pioneers</span>
        </h1>
        ...
        <p className="font-body text-base sm:text-lg lg:text-xl text-white/85 mb-10 sm:mb-12 max-w-2xl mx-auto leading-relaxed px-2">
          The ultimate teen camp experience! A specialized program designed for young teens combining epic trips, advanced electives, and leadership development.
        </p>
...
function PioneersFastFacts() {
  const facts = [
    {
      icon: Users,
      label: 'Ages',
      value: '9–11 Years Old',
...
const highlights = [
  ...
  { icon: Sparkles,     label: 'Spa Days & Specialized Electives', color: 'text-secondary-pink',    bg: 'bg-secondary-pink/10',   iconBg: 'bg-secondary-pink/20',   ring: 'ring-secondary-pink/20' },
  ...
  { icon: Zap,          label: 'Independence & Social Time',       color: 'text-secondary-yellow',  bg: 'bg-secondary-yellow/10', iconBg: 'bg-secondary-yellow/20', ring: 'ring-secondary-yellow/20' },
  { icon: Trophy,       label: 'Leadership Training',              color: 'text-primary',           bg: 'bg-primary/10',          iconBg: 'bg-primary/15',          ring: 'ring-primary/20' },
];
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="font-body text-base sm:text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            A premium program built around the things that truly matter to teens — independence, achievement, and unforgettable experiences.
          </p>
        </div>
    ...
    >
      ...
      <div className="relative max-w-2xl mx-auto">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="font-body text-base sm:text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Every hour is intentional — built for teens who want real challenge, real freedom, and real fun.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl ring-1 ring-gray-100 shadow-xl overflow-hidden">
          <div className="px-5 py-4 sm:px-8 sm:py-5 flex items-center gap-3" style={{ backgroundColor: COLOR }}>
            ...
            <p className="font-headline text-lg sm:text-xl font-bold leading-tight text-white">
              Pioneers <span className="font-normal opacity-75 text-base">— Ages 9–11</span>
            </p>
          </div>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-primary rounded-3xl px-8 py-10 sm:px-12 sm:py-12 shadow-xl shadow-primary/20 text-center">
          ...
          <div className="relative">
            ...
            <p className="font-body text-white/75 text-base sm:text-lg max-w-md mx-auto leading-relaxed mb-8">
              View our full summer schedule, session dates, and tuition options for Gan Izzy Pioneers.
            </p>
            <a
              href="/dates-rates"
              onClick={(e) => { e.preventDefault(); navigate('/dates-rates'); }}
