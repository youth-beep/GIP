import {
  ArrowRight, Clock, MapPin, Users, Star, Sun, Waves,
  Dumbbell, FlaskConical, Trophy, ChefHat,
  Sparkles, Compass, CalendarDays, DollarSign, Utensils, Flag, Music,
} from 'lucide-react';
    ...
    <section className="relative overflow-hidden min-h-[85vh] flex items-center px-4 py-12 sm:px-8 sm:py-16 lg:px-12 lg:py-28">
      ...
      <div className="relative w-full max-w-5xl mx-auto text-center animate-fade-in-up">
        ...
        <h1 className="font-headline text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white mb-5 sm:mb-7 leading-[0.95] tracking-tight">
          Gan Izzy
          <br />
          <span className="text-primary drop-shadow-lg">Seniors</span>
        </h1>
        ...
        <p className="font-body text-base sm:text-lg lg:text-xl text-white/85 mb-10 sm:mb-12 max-w-2xl mx-auto leading-relaxed px-2">
          Real adventure, epic trips, and deep friendships! A premium day camp experience built for older campers who are ready for more independence and bigger thrills.
        </p>
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap sm:justify-center gap-2 sm:gap-3 max-w-sm mx-auto sm:max-w-none">
          ...
          <div className="flex items-center gap-2 bg-white/15 backdrop-blur-sm px-3 py-2.5 sm:px-4 sm:py-2.5 rounded-full shadow-sm ring-1 ring-white/25 border border-white/20 min-h-[44px]">
            ...
            <span className="font-body font-bold text-xs sm:text-sm text-white leading-tight">Off-Site Excursions</span>
          </div>
          <div className="flex items-center gap-2 bg-white/15 backdrop-blur-sm px-3 py-2.5 sm:px-4 sm:py-2.5 rounded-full shadow-sm ring-1 ring-white/25 border border-white/20 min-h-[44px]">
...
const highlights = [
  { icon: Compass,      label: 'Weekly Major Excursions',          color: 'text-secondary-green',   bg: 'bg-secondary-green/10',  iconBg: 'bg-secondary-green/20',  ring: 'ring-secondary-green/20' },
  ...
  { icon: Sun,          label: 'Beach Time',                       color: 'text-secondary-yellow',  bg: 'bg-secondary-yellow/10', iconBg: 'bg-secondary-yellow/20', ring: 'ring-secondary-yellow/20' },
  { icon: FlaskConical, label: 'Hands-on Science',                 color: 'text-secondary-blue',    bg: 'bg-secondary-blue/10',   iconBg: 'bg-secondary-blue/20',   ring: 'ring-secondary-blue/20' },
  { icon: Dumbbell,     label: 'Advanced Athletics',               color: 'text-secondary-green',   bg: 'bg-secondary-green/10',  iconBg: 'bg-secondary-green/20',  ring: 'ring-secondary-green/20' },
  { icon: ChefHat,      label: 'Pizza Making & Culinary',          color: 'text-secondary-yellow',  bg: 'bg-secondary-yellow/10', iconBg: 'bg-secondary-yellow/20', ring: 'ring-secondary-yellow/20' },
  { icon: Trophy,       label: 'Leadership & Values',              color: 'text-primary',           bg: 'bg-primary/10',          iconBg: 'bg-primary/15',          ring: 'ring-primary/20' },
];
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="font-body text-base sm:text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Bigger adventures, deeper connections, and real-world skills for campers ready to level up.
          </p>
        </div>
...
const schedule = [
  { time: '9:30 AM',  activity: 'Morning Lineup',                  icon: Flag },
  { time: '10:00 AM', activity: 'Swimming',                        icon: Waves },
  { time: '11:30 AM', activity: 'Sports Leagues & Tournaments',    icon: Trophy },
  { time: '12:30 PM', activity: 'Lunch & Social Time',             icon: Utensils },
    ...
    >
      ...
      <div className="relative max-w-2xl mx-auto">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="font-body text-base sm:text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            A power-packed day designed for campers who want real challenge and real fun.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl ring-1 ring-gray-100 shadow-xl overflow-hidden">
          <div className="px-5 py-4 sm:px-8 sm:py-5 flex items-center gap-3" style={{ backgroundColor: COLOR }}>
            ...
            <p className="font-headline text-lg sm:text-xl font-bold leading-tight text-white">
              Seniors <span className="font-normal opacity-75 text-base">— Ages 7–8</span>
            </p>
          </div>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-primary rounded-3xl px-8 py-10 sm:px-12 sm:py-12 shadow-xl shadow-primary/20 text-center">
          ...
          <div className="relative">
            ...
            <p className="font-body text-white/75 text-base sm:text-lg max-w-md mx-auto leading-relaxed mb-8">
              View our full summer schedule, session dates, and tuition options for Gan Izzy Seniors.
            </p>
            <a
              href="/dates-rates"
              onClick={(e) => { e.preventDefault(); navigate('/dates-rates'); }}
