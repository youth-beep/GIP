import {
  ArrowRight, Clock, MapPin, Users,
  Star, Sun, Waves, Dumbbell,
  FlaskConical, Hammer, Trophy, ChefHat, Heart,
  CalendarDays, DollarSign, Utensils, Sparkles, Flag, Zap, Music,
} from 'lucide-react';
    ...
    <section className="relative overflow-hidden min-h-[85vh] flex items-center px-4 py-12 sm:px-8 sm:py-16 lg:px-12 lg:py-28">
      ...
      <div className="relative w-full max-w-5xl mx-auto text-center animate-fade-in-up">
        ...
        <h1 className="font-headline text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white mb-5 sm:mb-7 leading-[0.95] tracking-tight">
          Gan Izzy
          <br />
          <span className="text-primary drop-shadow-lg">Juniors</span>
        </h1>
        ...
        <p className="font-body text-base sm:text-lg lg:text-xl text-white/85 mb-10 sm:mb-12 max-w-2xl mx-auto leading-relaxed px-2">
          Action, arts, and adventure! The ultimate, high-energy day camp experience tailored specifically for our early elementary campers.
        </p>
...
const highlights = [
  { icon: Waves,       label: 'Professional Swim Lessons',    color: 'text-secondary-blue',   bg: 'bg-secondary-blue/10',   iconBg: 'bg-secondary-blue/20',   ring: 'ring-secondary-blue/20' },
  { icon: Star,        label: 'Day Trips',                    color: 'text-secondary-yellow',  bg: 'bg-secondary-yellow/10', iconBg: 'bg-secondary-yellow/20', ring: 'ring-secondary-yellow/20' },
  { icon: Dumbbell,    label: 'Action-Packed Sports',         color: 'text-secondary-green',   bg: 'bg-secondary-green/10',  iconBg: 'bg-secondary-green/20',  ring: 'ring-secondary-green/20' },
  ...
  { icon: Hammer,      label: 'Woodworking Projects',         color: 'text-secondary-pink',    bg: 'bg-secondary-pink/10',   iconBg: 'bg-secondary-pink/20',   ring: 'ring-secondary-pink/20' },
  { icon: Trophy,      label: 'Epic Camp Spirit & Rallies',   color: 'text-primary',           bg: 'bg-primary/10',          iconBg: 'bg-primary/15',          ring: 'ring-primary/20' },
  { icon: ChefHat,     label: 'Culinary Arts',                color: 'text-secondary-green',   bg: 'bg-secondary-green/10',  iconBg: 'bg-secondary-green/20',  ring: 'ring-secondary-green/20' },
  { icon: Heart,       label: 'Warm Jewish Culture',          color: 'text-secondary-pink',    bg: 'bg-secondary-pink/10',   iconBg: 'bg-secondary-pink/20',   ring: 'ring-secondary-pink/20' },
];
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="font-body text-base sm:text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            High-energy days filled with skill-building, creativity, adventure, and lifelong friendships.
          </p>
        </div>
...
const schedule = [
  { time: '9:30 AM',  activity: 'Morning Lineup & Tefillah',   icon: Flag },
  { time: '10:00 AM', activity: 'Swimming',                    icon: Waves },
  { time: '11:30 AM', activity: 'Action-Packed Sports',        icon: Zap },
  { time: '12:30 PM', activity: 'Lunch & Free Time',           icon: Utensils },
    ...
    >
      ...
      <div className="relative max-w-2xl mx-auto">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="font-body text-base sm:text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Every hour is crafted for maximum fun, learning, and lasting memories.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl ring-1 ring-gray-100 shadow-xl overflow-hidden">
          <div className="px-5 py-4 sm:px-8 sm:py-5 flex items-center gap-3" style={{ backgroundColor: COLOR }}>
            ...
            <p className="font-headline text-lg sm:text-xl font-bold leading-tight text-white">
              Juniors <span className="font-normal opacity-75 text-base">— Ages 5–6</span>
            </p>
          </div>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-primary rounded-3xl px-8 py-10 sm:px-12 sm:py-12 shadow-xl shadow-primary/20 text-center">
          ...
          <div className="relative">
            ...
            <p className="font-body text-white/75 text-base sm:text-lg max-w-md mx-auto leading-relaxed mb-8">
              View our full summer schedule, session dates, and tuition options for Gan Izzy Juniors.
            </p>
            <a
              href="/dates-rates"
              onClick={(e) => { e.preventDefault(); navigate('/dates-rates'); }}
